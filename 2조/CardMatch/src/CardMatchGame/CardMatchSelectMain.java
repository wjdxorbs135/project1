...
public class CardMatchSelectMain extends JFrame {

	private static final long serialVersionUID = 1L;
	
	private JPanel contentPane;

	public CardMatchSelectMain(CardMatchGame c) {
		...
		JLabel lblDifficulty = new JLabel("메인메뉴로 나가시겠습니까?");
